export const projetcs = [
  {
    ...
    description:
      'SAAS desenvolvido para gerentes/C-level para obter análises gráficas baseadas em dashboards onde todos os dados são extraídos de um banco de dados remoto para a aplicação do Koios e então é possível realizar o armazenamento desses dados para criaçãos dos dashboards.',
    link: 'https://github.com/Antony-Lucas/Koios-BI-',
    liveLink: false,
  },
  {
  ...
  {
    img: '../../../assets/projects/forum.webp',
    title: 'Fórum hospitalar',
    techStack: 'JavaScript, HTML, CSS, JAVA, SpringBoot, PostgreSQL',
    description:
  ...
  },
  {
    ...
    title: 'Trilog Express',
    techStack: 'JavaScript, HTML, CSS',
    description:
      'Plataforma WEB da Empresa Trilog Express para expor seus serviços e parcerias, o usuário pode enviar mensagem para emrpesa através da plataforma',
    link: 'https://github.com/Antony-Lucas/Trilog_express',
    liveLink: 'https://antony-lucas.github.io/Trilog_express/',
  },
  {
