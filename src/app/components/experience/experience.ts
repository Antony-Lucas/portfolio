export const experience = [
  {
    img: '../../../assets/experience/knowbi.svg',
    title: 'KnowBI',
  ...
  {
    img: '../../../assets/experience/philips.svg',
    title: 'Philips / Empresa parceira',
  ...
  },
  {
    ...
    title: 'Microlins',
    cargo: 'Instrutor de TI',
    description:
      'Atuei como instrutor no setor de TI da empresa após concluir meus primeiros cursos na escola, começando como estagiário dando aulas de Hardware e Informática básica. Após o estágio, continuei ministrando aulas, além de realizar manutenção e gerenciamento dos sistemas internos, acompanhamento dos alunos, controle de conteúdo e atividades, e administração de recursos em sala de aula utilizando CRM interno, Excel, PowerBI e outras ferramentas do Office.',
    init: '15 Jan 2019',
    end: '1 Ago 2022',
  },
];
